...
<tr>
 <td>
   <a href="controlpdfexperience.md">
    ...
    <div>
   <a href="controlpdfexperience.md"><strong>Kontrollera onlineupplevelsen i PDF och samla in analyser</strong></a>
    </div>
  ...
  <td>
   ...
   <a href="https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/2021/oct2021/pdf-embed-api.html"><strong>Kämpa med PDF på webben som ett proffs</strong></a>
    ...
    <em>Se hur du kan använda det kostnadsfria Adobe PDF Embed API för att göra det enklare att använda PDF på din webbplats</em>
    <br>
  </td>
  <td>
